...
PKGSRCLABEL := cairo-dock-plug-ins
PKGVER := 3.4.1
PKGSRC := $(PKGSRCLABEL)-$(PKGVER).tar.gz
PKGSRCDIR := $(TCBUILDROOT)/$(PKGNAME)-$(PKGVER)
PKGOBJDIR := $(TCBUILDROOT)/$(PKGNAME)-$(PKGVER)-obj
PATCHLIST := $(PATCHDB)/$(PKGNAME)/list.txt
PATCHDIR := $(PATCHDB)/$(PKGNAME)
SRCURL := https://github.com/Cairo-Dock/$(PKGSRCLABEL)/releases/download/$(PKGVER)/$(PKGSRC)
COPTS := -D BUILD_SHARED_LIBS=ON \
	-D enable-python-interface=OFF \
	...
	-D PKG_CONFIG_EXECUTABLE=$(CROSSTOOLS)/bin/$(TARGETARCH)-pkg-config
